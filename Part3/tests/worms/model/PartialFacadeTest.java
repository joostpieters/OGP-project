...
public class PartialFacadeTest {
	...
	public void testProgram() {
		...
		World world = facade.createWorld(100.0, 100.0, new boolean[][] {
				{ true }, { false } }, random);
		...
		Worm worm = facade.createWorm(world, 50.0, 50.51, 0, 0.5, "Test",
				program);
		//facade.addNewWorm(world, null); // add another worm
		// NOTE: method as stated in assignment can impossible find a adjacent position for a random worm and thus it's better to create and add a new worm.
		facade.createWorm(world, 50.0, 50.51, 0, 0.5, "Tester", null); 
		...
		assertNotEquals(worm, facade.getCurrentWorm(world)); // turn must end
																// after
																// executing
																// program
	}
