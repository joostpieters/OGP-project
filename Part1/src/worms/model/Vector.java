...
/**
 * A class of vectors involving a coordinate and a direction.
 * 
...
public class Vector {
	 ...
	 */
	@Raw
	public Vector(Coordinate coordinate, double direction) throws ModelException {
	 ...
	 */
	@Raw
	public void changeDirection(double turningAngle){
		assert (this.canAcceptForChangeDirection(turningAngle)) : 
					"Precondition: acceptable direction";
		this.direction = this.getDirection() + turningAngle;
	}
	 ...
	 *			|			!(this.getDirection() < 0 && turningAngle == Double.MIN_VALUE) &&
	 *			|				!(this.getDirection() > 0 && turningAngle == Double.MAX_VALUE)
	 */
	@Raw
	public boolean canAcceptForChangeDirection(double turningAngle){
	...
	/**
	 * Return the coordinate of this vector.
	 *	The coordinate of a vector determines where the vector is located.
	 */
	@Basic
	@Raw
