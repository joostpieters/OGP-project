...
public class IllegalMoveException extends RuntimeException {
	 ...
	 *         super()
	 */
	public IllegalMoveException(Worm worm, int nbSteps) {
		this.worm = worm;
	...
	/**
	 * Return the number of steps of this illegal move exception.
	 */
	@Basic
	@Immutable
	...
	/**
	 * Variable registering the number of steps of this illegal move exception.
	 */
